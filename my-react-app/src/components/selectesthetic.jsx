  ...
  return (
    <div>
        ...
        <div className='icons3'>
          <img src={icon1} alt="" style={{borderRadius:'20px',width:'640px',height:'355px'}} onClick={() => handleClick('http://localhost:5173/home/selectaesthetic/minimalist')} />
          <h2 className='text-overlay'>Minimalist</h2>
          </div>
        <div className='icons3'> 
            <img src={icon2} alt="" style={{ borderRadius:'20px',width:'640px',height:'355px'}} onClick={() => handleClick('http://localhost:5173/home/selectaesthetic/streetwear')}/>
            <h2 className='text-overlay2'>Street Wear</h2>
          </div>
        <div className='icons3'>
          <img src={icon3} alt="" style={{borderRadius:'20px',width:'640px',height:'355px'}} onClick={() => handleClick('http://localhost:5173/home/selectaesthetic/vintage')} />
