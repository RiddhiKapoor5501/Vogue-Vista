...
function Quiz() {
  ...
  const renderResult = () => (
    <h2>Your dominant aesthetic is: {aesthetic} <br/> <div className='clickhere' onClick={() => handleClick('http://localhost:5173/home/selectaesthetic')}>Click here to shop</div> </h2>
  );
